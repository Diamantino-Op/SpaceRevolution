...
import com.diamantino.spacerevolution.blockentities.cables.FluidPipeBlockEntity;
...
public class FluidPipeBlock extends BlockWithEntity implements Waterloggable {
    ...
    public final CableVariants.Fluid type;

    public FluidPipeBlock(CableVariants.Fluid type) {
        super(Settings.of(Material.METAL).strength(1f, 8f).nonOpaque());
        this.type = type;
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return (world1, pos, state1, blockEntity) -> ((FluidPipeBlockEntity) blockEntity).tick(world1, pos, state1, (FluidPipeBlockEntity) blockEntity);
    }
